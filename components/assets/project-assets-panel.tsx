            ...
            >
              <div className="flex flex-wrap items-start justify-between gap-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center rounded-2xl border border-neutral-line bg-surface px-4 py-2 text-sm font-medium text-text-main transition hover:bg-surface-alt"
                >
                  Open file
                </a>
              </div>
