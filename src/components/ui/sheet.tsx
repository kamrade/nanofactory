...
export function UISheetContent({
  ...
  const panel = (
    ...
    >
      ...
      <div
        className={cx(
          "absolute top-0 h-full max-w-2xl transform-gpu border border-line bg-surface outline-none will-change-transform contain:[layout_paint] transition-transform duration-200 ease-out",
