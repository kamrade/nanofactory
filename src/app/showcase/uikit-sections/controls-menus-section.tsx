...
export function ControlsAndMenusSection({ uiSize }: { uiSize: UiSize }) {
  ...
  return (
    <>
      <UikitSectionAnchor id="controls-checkbox">
      ...
      <UikitSectionAnchor id="controls-switcher">
      ...
      <UikitSectionAnchor id="controls-segmented-control">
      ...
      <UikitSectionAnchor id="controls-menu">
